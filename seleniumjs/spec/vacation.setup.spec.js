...
describe('set up vacation', () => {
    ...
    it('click "add vacation" button', () => {
        let addVacButton = browser.findElement(PROTRACTOR.By.css(CONSTANTS.CSS_SELECTORS.BUTTONS.add_new_vacation .add_new_vacation_button));
    ...
    describe('check default form fields on "Student" position', () => {
        ...
        it('"Employee" filed must be equals for logged in user', () => {
            username_element = browser.findElement(PROTRACTOR.by.css(CONSTANTS.CSS_SELECTORS.employee_input));
            let currentUserName = browser.findElement(PROTRACTOR.by.css(CONSTANTS.CSS_SELECTORS.userName_text))
        ...
        it('"Approver" field should be "Kanstantsin Ausiannikau"', () => {
            approver_element = browser.findElement(PROTRACTOR.by.css(CONSTANTS.CSS_SELECTORS.approver_text))
        ...
        it('"Leave w/o pay type" field must be "General leave"', () => {
            leave_pay_type_element = browser.findElement(PROTRACTOR.by.css(CONSTANTS.CSS_SELECTORS.leave_pay_type_text))
        ...
        it('"Comment" filed must be empty', () => {
            comment_element = browser.findElement(PROTRACTOR.by.css(CONSTANTS.CSS_SELECTORS.comment_text))
    ...
    it('send request to draft', () => {
        let saveAsDraft_button = browser.findElement(PROTRACTOR.by.css(CONSTANTS.CSS_SELECTORS.save_as_draft_button))
    ...
    it('should see "Request successfully saved" alert', () => {
        let popupMessage_element = browser.findElement(PROTRACTOR.By.css(CONSTANTS.CSS_SELECTORS.request_popup_message_successful));
    ...
    it('vacation list is not empty', () => {
        let vacationList = browser.findElements(PROTRACTOR.by.css(CONSTANTS.CSS_SELECTORS.vacation_list_items)).then(element => {
